...
export const ToggleAttributes: React.FC<ToggleAttributesProps> = ({ className }) => {
	...
	return (
		<div className={className}>
			{!isAttributesVisible && (
				<button onClick={toggleAttributes}>
					Show these numbers meaning
				</button>
			)}
			{isAttributesVisible && (
                <>
                    <button onClick={toggleAttributes}>Hide</button>
